...
build agent never sees test scaffolding as if it were part of the technique.
    ...
    python -m bambi_vfx.verify_recipes                 # spike everything, write the ledger
    python -m bambi_vfx.verify_recipes --name night-city-field
    python -m bambi_vfx.verify_recipes --audit         # no Blender: claims vs ledger
    python -m bambi_vfx.verify_recipes --sync          # make frontmatter match the evidence
    python -m bambi_vfx.verify_recipes --demote        # downgrade only, never upgrade
"""
