...
# Loaded BY PATH, not as `bambi_vfx.geom`. Blender ships its own Python without the repo's
# dependencies, so importing the package runs `bambi_vfx/__init__.py` and dies on
