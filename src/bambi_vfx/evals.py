...
actually helped.
    ...
    python -m bambi_vfx.evals compare  barrel_roll:latest evals/baselines/.../x.json
    python -m bambi_vfx.evals panels                                # free, from ledgers
    python -m bambi_vfx.evals list
...
def _cmd_checks(argv: list[str]) -> int:
    ...
    """
    ap = argparse.ArgumentParser(prog="bambi_vfx.evals checks")
...
def _cmd_check(argv: list[str]) -> int:
    ap = argparse.ArgumentParser(prog="bambi_vfx.evals check")
...
def _cmd_compare(argv: list[str]) -> int:
    ap = argparse.ArgumentParser(prog="bambi_vfx.evals compare")
...
def _cmd_list(argv: list[str]) -> int:
    ap = argparse.ArgumentParser(prog="bambi_vfx.evals list")
