...
write is `artifacts/evaluations/` at the repo root, deliberately OUTSIDE `shots/` so a rebuild
...
# Repo root, then the generated evidence store. NOT under shots/ — see the module docstring.
REPO = PROJECT_ROOT
STORE = REPO / "artifacts" / "evaluations"
BASELINES = STORE / "baselines"
VARIANCE = STORE / "variance"

__all__ = ["BASELINES", "REPO", "STORE", "VARIANCE"]
