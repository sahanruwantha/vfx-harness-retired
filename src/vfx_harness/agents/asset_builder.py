...
Usage:
    python -m vfx_harness.agents.asset_builder <shot-folder>
"""
...
from vfx_harness.infrastructure.config import DEFAULT_EXECUTION_MODEL, Settings, load_environment
...
ASSET_SYSTEM = """\
You are the ASSET agent in an automated 3D/VFX vfx_harness. You build the bespoke,
