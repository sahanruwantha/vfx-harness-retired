...
volume, but the treatment approved here has to survive the shot's atmosphere.
    ...
    .venv/bin/python docs/research/probes/spike_lookdev.py
"""
...
from vfx_harness.application.facade import compare_profiles, facade_profile, render_profile

shot = load_shot("shots/barrel_roll")
OUT = Path("/tmp/claude-1000/-home-sahan-Desktop-vfx-harness/"
