...
Writes under `evals/blank/`, never into the shot folder.
"""
...
async def measure(shot: Shot, *, layer_id: str | None = None,
    ...
    from ..build_agent import _critique
    ...
    # The black frame is written under evals/, never into the shot — nothing in this
...
def main(argv: list[str]) -> int:
    ...
    ap = argparse.ArgumentParser(prog="pipeline.evals blank")
